  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Home">
        ...
        <Stack.Screen name="Dashbord" component={DashBord} options={{
          title: 'Home',
...
//   fetch_weather = () => {
//     fetch('https://samples.openweathermap.org/data/2.5/weather?q=india,uk&appid=078af22c7eacf5c5e27dec9e1667d954')
